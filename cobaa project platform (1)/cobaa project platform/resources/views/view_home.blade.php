...
@section('isihalaman')
    ...
    <br>
        <p>
    <h4>Perpustakaan USD</h4>
        Perpustakaan Universitas Sanata Dharma [USD] sebagai salah satu perpustakaan perguruan tinggi swasta di Indonesia selama ini juga telah melaksanakan kelima tugas tersebut dalam kegiatan di perpustakaannya untuk mendukung terwujudnya Tri Dharma Perguruan Tinggi. Berbagai upaya dilakukan oleh Perpustakaan Universitas sendiri berada ditempat yang cukup representative, mudah diakses baik oleh mahasiswa ataupun kalangan civitas akademika USM.
    </p>
    <br>
    <p>
