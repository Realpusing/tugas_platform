                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form name="formpinjamedit" id="formpinjamedit" action="/pinjam/edit/{{ $p->id_pinjam}} " method="post" enctype="multipart/form-data">
                                            ...
                                            <p>
                                            <div class="form-group row">
                                                <label for="user" class="col-sm-4 col-form-label">Nama Petugas</label>
                                                <div class="col-sm-8">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form name="formpinjamtambah" id="formpinjamtambah" action="/pinjam/tambah " method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group row">
                            <label for="id" class="col-sm-4 col-form-label">Nama Petugas</label>
                            <div class="col-sm-8">
                                <select type="text" class="form-control" id="id" name="id" placeholder="Pilih Nama Petugas">
                                    @foreach ($users as $us)
                                        @if ($us->level == 'admin')
                                            <option value="{{ $us->id }}">{{ $us->name }}</option>
                                        @endif
