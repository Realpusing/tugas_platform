                    ...
                    <div class="col-md-5 mx-auto">
                        <div class="card card-body">
                            ...
                            <div class="form-group required">
                                    <lSabel for="username">Nomor Admin</lSabel>
                                    <input type="text"  class="form-control text-lowercase" required="" name="nomor" placeholder="Nomor Admin">
                                </div>                    
                                <div class="form-group required">
                            ...
                            <p class="small-xl pt-3 text-center">
                                <span name =""submitclass="text-muted">Masuk Sebagai User?</span>
                                <a href="/" name="">Login</a>
                            </p>
                        </div>
                    </div>
